...
class LogFooter extends HTMLElement {
    ...
    render() {
        this.innerHTML = /*html */`
            ...
            <nav class="navbar navbar-expand-lg bottom-navbar">                
                <div class="container-fluid" style="display: flex; align-items: center; gap: 0;">            
                     <ul class="navbar-nav mb-2 mb-md-0" style="margin-bottom: 0; margin-right: 0;">                 
                        ...
                        <li class="navbar-text text-white" style="margin-left: 8px;" id="flight-label">
                            Date
                        </li>
                    </ul>
                </div>
    ...
    setupEventListeners() {
        document.querySelector('log-table').addEventListener('row-selected', (event) => {
            ...
            document.getElementById('flight-label').innerHTML = rowData.V_Site+'&nbsp;&nbsp;&nbsp;'+rowData.V_Engin+'&nbsp;&nbsp;&nbsp;'+rowData.Day + ' ' + rowData.Hour;
